...
import { NftManagerOpcodes } from "../constants.ts";
import { encodeOffChainContent } from "./../utils/nft-content.ts";

import {
  NftManagerCodeCell,
  NftManagerSystemCell,
} from "./NftManager.source.ts";

export function buildNftManagerDataCell(
